				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=23"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=23">Cam Sành Hữu Cơ - 1Kg</a>
						</h6>
						<h5>65.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=24"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=24">Ớt chuông xanh 1kg</a>
						</h6>
						<h5>65.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=26"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=26">Cherry Úc - 0.5Kg</a>
						</h6>
						<h5>499.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=27"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=27">Hành tây Đà Lạt 500g</a>
						</h6>
						<h5>40.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=28"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=28">Chuối tiêu - 1Kg</a>
						</h6>
						<h5>75.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=29"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=29">Lựu đỏ - 0.5Kg</a>
						</h6>
						<h5>239.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=30"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=30">Kiwi vàng - 0.5Kg</a>
						</h6>
						<h5>165.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=31"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=31">Cải bẹ xanh 400g</a>
						</h6>
						<h5>15.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=32"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=32">Hamburger</a>
						</h6>
						<h5>45.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=1"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=1">Gầu bò Mỹ - 300g</a>
						</h6>
						<h5>149.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=33"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=33">Hot dog</a>
						</h6>
						<h5>35.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=34"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=34">Rau dền 400g</a>
						</h6>
						<h5>15.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=2"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=2">Bò tái Úc - 250g</a>
						</h6>
						<h5>109.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=3"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=3">Sườn non heo C.P khay 500g</a>
						</h6>
						<h5>209.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=35"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=35">Cải thìa 400g</a>
						</h6>
						<h5>20.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=4"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=4">Cá chép khay 800g</a>
						</h6>
						<h5>199.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=36"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=36">Rau muống 400g</a>
						</h6>
						<h5>15.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=5"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=5">Tôm thẻ khay 300g</a>
						</h6>
						<h5>89.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=6"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=6">Ức gà phi lê 300g</a>
						</h6>
						<h5>39.000đ</h5>
					</div>
				</div>
