						...
						<div class="col-lg-4 col-md-6">
							<div class="checkout__order">
								...
								<div class="checkout__order__subtotal">
									Tạm tính <span>${total/1000}00đ</span>
								</div>
								<div class="checkout__order__total">
									Giảm giá <span>0đ</span>
								</div>
								<div class="checkout__order__total">
									Tổng tiền <span>${total/1000}00đ</span>
								</div>
								...
								<%--                            </c:if>--%>
								<input style="width: 100%; font-size: 1rem" class="site-btn"
									type="submit" value="ĐẶT HÀNG" />

								<div class="vat-p">
									<span style="float: right; margin: .3rem 0; font-size: .9rem;"><i>(Đã
											bao gồm VAT nếu có)</i></span>
								</div>
