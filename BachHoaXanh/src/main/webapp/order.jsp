						...
						<table width="100%">
							<tbody>
								<tr>
											...
											<tbody>
												<tr>
													<td style="text-align: left">
														<p>1. Bằng việc tiến hành Đặt Hàng, khách hàng đồng ý
															với các Điều Kiện Giao Dịch Chung được ban hành bới
															OganiNLU.</p>
														<p>2. Liên hệ với chúng tôi nếu bạn gặp vấn đề trong
															việc nhận hàng.</p>
														<p>3. Mọi phản hồi xin gửi về:</p>
														<p style="padding-left: 20px">
															OganiNLU - Thực phẩm hữu cơ <br /> 8989 Xa lộ Hà Nội <br />
															Khu Phố 5, P. Linh Trung, Thủ Đức, TP. Hồ Chí Minh <br />
									...
									<td
										style="padding-left: 40px; padding-right: 21px; width: 50%; vertical-align: top">
										<table style="width: 100%">
											<tbody>
												<tr>
