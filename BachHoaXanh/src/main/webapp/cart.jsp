						...
						<table>
							...
							<tbody>
								...
								<c:forEach items="${data}" var="d">
									<tr>
										<td class="shoping__cart__item"><img src="${d.img}"
											style="width: 100px; height: 100px" alt="">
											<h5>${d.name}</h5></td>
										<td class="shoping__cart__price">${d.price}</td>
										<td class="shoping__cart__quantity">
											<div class="quantity">
												<div class="pro-qty">

													<a href="desCart?id=${d.id}&quantity=${d.quantity}"><span
														class="dec qtybtn">-</span></a> <input name="quantity"
														type="text" value="${d.quantity}"> <a
														href="addCart?id=${d.id}"><span class="inc qtybtn">+</span></a>
												</div>
											</div>
										</td>
										<td class="shoping__cart__total">${d.quantity * d.priceLong /1000}00đ
										</td>
										<td class="shoping__cart__item__close"><a
											href="desCart?id=${d.id}&quantity=0"><span
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="shoping__cart__btns">
						...
						<a href="refresh" class="primary-btn cart-btn cart-btn-right"><span
							class="icon_loading"></span> Cập nhật</a>
					</div>
				</div>
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					<div class="shoping__checkout">
						...
						<c:if test="${sessionScope.acc == null}">
							<a href="login.jsp?from=${pageContext.request.requestURI}"
		...
		(function($) {
			...
			$('.product__details__pic__slider img').on(
					...
					function() {
						...
						var bigImg = $('.product__details__pic__item--large')
								.attr('src');
						if (imgurl != bigImg) {
