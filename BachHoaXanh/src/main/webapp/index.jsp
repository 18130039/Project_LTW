	...
	<div class="container">
		<div class="row">
			<div class="categories__slider owl-carousel">
				...
				<div class="col-lg-3">
					<div class="categories__item set-bg"
						data-setbg="img/categories/cat-4.png">
						<h5>
							<a>Thịt tươi</a>
						</h5>
					</div>
	...
	<div class="container">
		...
		<div class="row featured__filter">
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=07"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=07">Cam Sành Hữu Cơ - 1Kg</a>
						</h6>
						<h5>65.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/otchuong.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=08"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=08">Ớt chuông xanh 1kg</a>
						</h6>
						<h5>65.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=09"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=09">Cherry Úc - 0.5Kg</a>
						</h6>
						<h5>499.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/hanhtay.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=10"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=10">Hành tây Đà Lạt 500g</a>
						</h6>
						<h5>40.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=11"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=11">Chuối tiêu - 1Kg</a>
						</h6>
						<h5>75.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fruits">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/luu.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=12"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=12">Lựu đỏ - 0.5Kg</a>
						</h6>
						<h5>239.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=13"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=13">Kiwi vàng - 0.5Kg</a>
						</h6>
						<h5>165.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/caibe.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=14"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=14">Cải bẹ xanh 400g</a>
						</h6>
						<h5>15.000đ</h5>
					</div>
				</div>
				...
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						...
						<ul class="featured__item__pic__hover">
							...
							<li><a href="addCart?id=15"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=15">Hamburger</a>
						</h6>
						<h5>45.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/thitbo.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=01"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=01">Gầu bò Mỹ - 300g</a>
						</h6>
						<h5>149.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fastfood">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/hotdog.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=16"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=16">Hot dog</a>
						</h6>
						<h5>35.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/rauden.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=17"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=17">Rau dền 400g</a>
						</h6>
						<h5>15.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/botai.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=02"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=02">Bò tái Úc - 250g</a>
						</h6>
						<h5>109.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/heocp.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=03"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=03">Sườn non heo C.P khay 500g</a>
						</h6>
						<h5>209.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/caithia.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=18"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=18">Cải thìa 400g</a>
						</h6>
						<h5>20.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/cachep.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=04"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=04">Cá chép khay 800g</a>
						</h6>
						<h5>199.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/raumuong.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=19"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=19">Rau muống 400g</a>
						</h6>
						<h5>15.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/tom.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=05"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=05">Tôm thẻ khay 300g</a>
						</h6>
						<h5>89.000đ</h5>
					</div>
				</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
				<div class="featured__item">
					<div class="featured__item__pic set-bg"
						data-setbg="img/product/ucga.jpg">
						<ul class="featured__item__pic__hover">

							<li><a href="addCart?id=06"><i
									class="fa fa-shopping-cart"></i></a></li>
						</ul>
					</div>
					<div class="featured__item__text">
						<h6>
							<a href="detail?pid=06">Ức gà phi lê 300g</a>
						</h6>
						<h5>39.000đ</h5>
					</div>
				</div>
